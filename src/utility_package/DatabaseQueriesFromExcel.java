...
public class DatabaseQueriesFromExcel {

	static   XSSFSheet sheet1;
	static  int a;

static File file = new File("src\\test_data\\valid_data_database_queries.xlsx");
static String path=file.getAbsolutePath();
		...
		public static String valid_username() throws Exception
		{    commfunc();             
		...
		public static String valid_password() throws Exception
		{    commfunc();             
